...
- (void)setUpSubViews{
    ...
    [self addSubview:_solveFirstLabel];
    //6.公司解决方案一价格
    ...
    [self addSubview:_solvePriceFirstLabel];
    //7.分割线
    ...
    [self addSubview:_solveSecondLabel];
    //9.公司解决方案二价格
    ...
    [self addSubview:_solvePriceSecondLabel];
}
...
- (void)layoutSubviews{
    ...
    [_companyLogoImageView sd_setImageWithURL:[NSURL URLWithString:@""] placeholderImage:[UIImage imageNamed:@"DefaultSmallIcon"]];
    //3.公司名字
    ...
    _solvePriceSecondLabel.frame = CGRectMake(_solveSecondLabel.left, _solveSecondLabel.bottom, solvePriceSecondLblWidthSize.width, solvePriceSecondLabelHeight);
    _solvePriceSecondLabel.text = solvePriceSecondProfitStr;
    [_solvePriceSecondLabel sizeToFit];
}
