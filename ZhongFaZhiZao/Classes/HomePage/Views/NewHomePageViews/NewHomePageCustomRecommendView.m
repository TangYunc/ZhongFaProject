...
- (void)setUpSubviews{
    ...
    _tipLabel = [[UILabel alloc] initWithFrame:CGRectMake(0,_goodsNameLabel.bottom + tipLabelGapFromTop, self.width, tipLabelHeight)];
    ...
    _tipLabel.layer.cornerRadius = _tipLabel.width / 8;
    _tipLabel.text = @"下单立项8折";
    //3.商品图
    ...
    [_goodsIconImageView sd_setImageWithURL:[NSURL URLWithString:@""] placeholderImage:[UIImage imageNamed:@"HomePageDatabaseIcon"]];
}
@end
