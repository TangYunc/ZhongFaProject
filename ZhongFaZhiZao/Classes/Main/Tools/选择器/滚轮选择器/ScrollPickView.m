...
@interface ScrollPickView ()<UIPickerViewDataSource, UIPickerViewDelegate>
...
- (instancetype)initWithQuestionArray:(NSArray *)questionArray withDefaultDesc:(NSString *)defaultDesc {
    ...
    if (self = [super init]) {
        ...
        //按钮所在区域
        UIView *viewBg = [[UIView alloc] initWithFrame:CGRectMake(0,0,kScreenWidth,KFloat(45))];
        ...
        cannel.frame = CGRectMake(KFloat(20), 0, KFloat(50), KFloat(45));
        [cannel setTitle:@"取消" forState:0];
        cannel.titleLabel.font = [UIFont systemFontOfSize:KFloat(16)];
        ...
        confirm.frame = CGRectMake(kScreenWidth - KFloat(70), 0, KFloat(50), KFloat(45));
        [confirm setTitle:@"确定" forState:0];
        confirm.titleLabel.font = [UIFont systemFontOfSize:KFloat(16)];
...
- (UIPickerView *)pickerView {
    ...
    if (!_pickerView) {
        _pickerView = [[UIPickerView alloc] initWithFrame:CGRectMake(0, KFloat(45), kScreenWidth, KFloat(180))];
