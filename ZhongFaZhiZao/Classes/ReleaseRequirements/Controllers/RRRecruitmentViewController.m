...
- (void)setUpSubviews{
    ...
    RRRecruitmentScrollView *recruitmentScr = [[RRRecruitmentScrollView alloc] initWithFrame:CGRectMake(0, customizedScrGapFromTop, kScreenWidth, kScreenHeight - customizedScrGapFromTop)];
    recruitmentScr.delegate = self;
    recruitmentScr.pagingEnabled = NO;
    recruitmentScr.bounces = YES;
    recruitmentScr.userInteractionEnabled = YES;
    //    _scrollView.showsHorizontalScrollIndicator = NO;
    recruitmentScr.contentSize = CGSizeMake(0,1.5 * kScreenHeight);
    [self.view addSubview:recruitmentScr];
